...
<head>
    ...
    <style>
        ...
        .hud-top {
            ...
            color: #fff; /* Always white on game canvas */
        }
        ...
        .hud-bottom {
            ...
            color: #aaa; /* Always light on game canvas */
        }
        ...
        #status-msg {
            ...
            z-index: 10;
            width: 80%;
            color: #fff; /* Always white text in overlay */
        }
        ...
        label { font-size: 14px; color: var(--secondary-text); display: flex; align-items: center; gap: 5px; }
